...
function ClientDashboardInner() {
  ...
  return (
    <div className="flex flex-col min-h-screen mt-12">
      {/* ── SUCCESS TOAST ── */}
      {showSuccessToast && (
        <div className="fixed top-20 right-2 sm:right-4 z-50 animate-in slide-in-from-top-4 fade-in duration-300 w-[calc(100vw-1rem)] sm:w-auto max-w-sm">
          <div className="bg-emerald-50 border border-emerald-200 shadow-xl rounded-xl p-3 sm:p-4 flex items-start gap-3 sm:gap-4 w-full">
                ...
                <div className="p-6 border-b border-[#E2E8F0]">
                  <div className="flex flex-col items-center text-center">
                    ...
                    <div className="flex items-center gap-1 mb-4">
                      {[...Array(5)].map((_, i) => (
                        <Star key={i} size={14} className={i < Math.round(Number(contactData?.rating || 0)) ? "fill-yellow-400 text-yellow-400" : "fill-gray-200 text-gray-200"} />
                      ))}
                    </div>
