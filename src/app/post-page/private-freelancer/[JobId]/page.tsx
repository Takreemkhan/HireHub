...
// import { usegetJobInvites, useProfile, usesendInviteJobs } from "@/app/hook/useProfile";
...
//     const { data: getjobInvites, isLoading: jobInvitesLoading, refetch } = usegetJobInvites(params.JobId);

//     const invitedFreelancerIds = [
//         ...(getjobInvites?.invites?.map((invite: any) => String(invite.freelancerId)) || []),
//         ...invitedIds.map(String),
//     ];
...
//         sendInvite(
//             {
//                 jobId: params.JobId || currentJobId,
//                 data: {
//                     invites:
...
//                                 isInvited={invitedFreelancerIds.includes(String(freelancer.userId))}
                        ...
                        {profileLoading ? (
                            ...
                            filteredFreelancers.map((freelancer: Freelancer) => (
                                <FreelancerCard
                                    ...
                                    onInvite={() =>
                                        handleInvite(freelancer.userId, freelancer.email, freelancer.name)
                                    }
                                />
                            ))
                        )}
