    ...
    return (
        <div className="p-8">
            <div className="flex items-center justify-between mb-8">
                <h2 className="text-2xl font-bold text-gray-900 font-display">Withdrawals</h2>
            ...
            <div className="space-y-8">
                ...
                <section className="bg-white border border-gray-100 rounded-xl p-6 shadow-sm">
                    <div className="flex justify-between items-start mb-6">
                        <h3 className="text-base font-semibold text-gray-900 border-b-2 border-orange-500 pb-1">Withdrawal methods</h3>
                ...
                {/* Withdrawal Schedule */}
                <section className="bg-white border border-gray-100 rounded-xl p-6 shadow-sm">
                    <h3 className="text-base font-semibold text-gray-900 mb-4">Auto-withdrawal schedule</h3>
                    <div className="p-4 bg-gray-50/50 rounded-xl border border-gray-100">
                        <p className="text-sm text-gray-700 leading-relaxed max-w-lg mb-4">
                            Earnings will be automatically withdrawn to your primary method twice per month (1st and 15th) if your balance is over <span className="font-bold">$100.00</span>.
                        </p>
                ...
                <div className="p-6 border-2 border-dashed border-gray-100 rounded-xl text-center">
                    <p className="text-sm font-medium text-gray-500 mb-1">Looking for your withdrawal history?</p>
